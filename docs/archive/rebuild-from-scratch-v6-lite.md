...
Review `rule_audit.json`, `validation_report.json`, and the optional inspection drift tables before
treating V2 as an improvement. V2 is an offline ablation, not a promoted runtime target.
