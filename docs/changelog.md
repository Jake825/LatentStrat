...
| V5.8 | current working tree plus V5.8 artifacts | Current local state | Walk-forward validation, common metrics, canonical week handling. | Current validation path; commit pending for latest docs/state. |
