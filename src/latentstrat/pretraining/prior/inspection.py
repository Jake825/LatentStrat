...
from latentstrat.pretraining.prior.model import TeamPriorDistiller
from latentstrat.pretraining.prior.train import PriorTensorDataset
...
def write_prior_inspection_artifacts(
    ...
    write_artifact_manifest(
        out,
        workflow="pretraining.prior.inspect",
        artifact_version="v6.1",
        resolved_config={"random_seed": inspection.random_seed},
        promotion_note="Interpretation aid for a prior checkpoint.",
    )
    return out
